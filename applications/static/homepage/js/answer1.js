    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $(".QuestionPage").append(
                ...
                '                                        <button type="button" \n' +
                '                                                class="Button FollowButton Button--primary Button--blue" disabled="disabled">\n' +
                '                                            关注问题\n' +
                '                                        </button>\n' +
                '                                        <button type="button" class="Button Button--blue" id="write-answer" disabled="disabled">\n' +
                ...
                '                                                class="Button Button--grey Button--withIcon Button--withLabel" disabled="disabled"><span\n' +
                ...
                '                                        </button>\n' +
                '                                        <button type="button"\n' +
                '                                                class="Button Button--plain Button--withIcon Button--withLabel" disabled><span\n' +
                '                                                style="display:inline-flex;align-items:center">​<svg\n' +
            ...
            $.each(result["answer_list"], function (i, val) {
                ...
                var card = '                                                    <div class="List-item" tabindex="0">\n' +
                    ...
                    '                                                                    </button>' +
                    '<button type="button"  class="Button ContentItem-action Button--plain Button--withIcon Button--withLabel"  disabled="disabled"><span style="display: inline-flex; align-items: center;">​<svg class="Zi Zi--Report Button-zi" fill="currentColor" viewBox="0 0 24 24" width="1.2em" height="1.2em"><path d="M19.947 3.129c-.633.136-3.927.639-5.697.385-3.133-.45-4.776-2.54-9.949-.888-.997.413-1.277 1.038-1.277 2.019L3 20.808c0 .3.101.54.304.718a.97.97 0 0 0 .73.304c.275 0 .519-.102.73-.304.202-.179.304-.418.304-.718v-6.58c4.533-1.235 8.047.668 8.562.864 2.343.893 5.542.008 6.774-.657.397-.178.596-.474.596-.887V3.964c0-.599-.42-.972-1.053-.835z" fill-rule="evenodd"></path></svg></span>举报</button>' +
                    '                                                                </div>\n' +
                    '                                                            </div>\n' +
                    '                                                        </div>\n' +
                    '                                                    </div>' +
